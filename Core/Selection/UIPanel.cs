...
namespace Kiskovi.Core
{
    public class UIPanel : MonoBehaviour
    {
        ...
        public virtual bool isInFront
        {
            get => _isInFront && !connectedPanels.Any(panel => panel.isInFront);
            protected set => _isInFront = value;
        }

        public virtual bool isOpened { get; protected set; }

        internal void ConnectPanel(UIPanel panel)
        {
            connectedPanels.Add(panel);
        }

        internal void DisconnectPanel(UIPanel panel)
        {
