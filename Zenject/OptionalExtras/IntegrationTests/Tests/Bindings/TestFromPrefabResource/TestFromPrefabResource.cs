...
namespace Zenject.Tests.Bindings
{
    public class TestFromPrefabResource : ZenjectIntegrationTestFixture
    {
        ...
        public IEnumerator TestTransientError()
        {
            ...
            Container
                .Bind<Foo>()
                .FromComponentInNewPrefabResource(PathPrefix + "asdfasdfas")
                .AsTransient()
                .NonLazy();
        ...
        public IEnumerator TestTransient()
        {
            ...
            Container
                .Bind<Foo>()
                .FromComponentInNewPrefabResource(PathPrefix + "Foo")
                .AsTransient()
                .NonLazy();
            Container
                .Bind<Foo>()
        ...
        public IEnumerator TestWithArgumentsFail()
        {
            ...
            Container
                ...
                .FromComponentInNewPrefabResource(PathPrefix + "GorpAndQux")
                .AsSingle()
                .NonLazy();
        ...
        public IEnumerator TestWithArguments()
        {
            ...
            Container
                .Bind(typeof(Gorp))
                .FromComponentInNewPrefabResource(PathPrefix + "Gorp")
        ...
        public IEnumerator TestWithAbstractSearchSingleMatch()
        {
            ...
            Container
                .Bind<INorf>()
                .FromComponentInNewPrefabResource(PathPrefix + "Norf")
                .AsCached()
                .NonLazy();
        ...
        public IEnumerator TestWithAbstractSearchMultipleMatch()
        {
            ...
            Container
                .Bind<INorf>()
                .FromComponentsInNewPrefabResource(PathPrefix + "Norf")
                .AsCached()
                .NonLazy();
        ...
        public IEnumerator TestMultipleMatchFailure()
        {
            ...
            Container
                .Bind<INorf>()
                .FromComponentsInNewPrefabResource(PathPrefix + "Foo")
                .AsSingle()
                .NonLazy();
            Assert.Throws(() => PostInstall());
            yield break;
        ...
        public IEnumerator TestCircularDependencies()
        {
            ...
            Container
                ...
                .FromComponentInNewPrefabResource(PathPrefix + "JimAndBob")
                .AsSingle()
                .NonLazy();
