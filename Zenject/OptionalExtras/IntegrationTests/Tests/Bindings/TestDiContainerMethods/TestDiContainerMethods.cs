...
namespace Zenject.Tests.Bindings
{
    public class TestDiContainerMethods : ZenjectIntegrationTestFixture
    {
        ...
        public IEnumerator TestInstantiateComponentOnNewGameObjectArgs()
        {
            ...
            var gorp = Container.InstantiateComponentOnNewGameObject<Gorp>(
                "sdf",
                new object[] { "zxcv" }
            );
        ...
        public IEnumerator TestInstantiatePrefabForMonoBehaviour()
        {
            ...
            var gorp = Container.InstantiatePrefabForComponent<Gorp>(
                GorpPrefab,
                new object[] { "asdf" }
            );
        ...
        public IEnumerator TestInstantiatePrefabResource()
        {
            ...
            var gorp = Container.InstantiatePrefabResourceForComponent<Gorp>(
                ResourcePrefix + "Gorp",
                new object[] { "asdf" }
            );
        ...
        public IEnumerator TestInstantiatePrefabForComponent()
        {
            ...
            var camera = Container.InstantiatePrefabForComponent<Camera>(
                CameraPrefab,
                new object[0]
            );
        ...
        public IEnumerator TestInstantiatePrefabForComponentMistake()
        {
            ...
            Assert.Throws(() =>
                Container.InstantiatePrefabForComponent<Camera>(
                    CameraPrefab,
                    new object[] { "sdf" }
                )
            );
        ...
        public IEnumerator TestInstantiateScriptableObjectResourceArgs()
        {
            ...
            Assert.Throws(() =>
                Container.InstantiateScriptableObjectResource<Gorp2>(ResourcePrefix + "Gorp2")
            );

            var gorp = Container.InstantiateScriptableObjectResource<Gorp2>(
                ResourcePrefix + "Gorp2",
                new object[] { "asdf" }
            );
        ...
        public IEnumerator TestInjectGameObjectForComponentMistake()
        {
            ...
            Assert.Throws(() =>
                Container.InjectGameObjectForComponent<Camera>(go, new object[] { "sdf" })
            );
            yield break;
        }
        ...
        public IEnumerator TestInstantiatePrefabForComponentExplicit()
        {
            ...
            var go = (Foo)
                Container.InstantiatePrefabForComponentExplicit(
                    typeof(Foo),
                    FooPrefab,
