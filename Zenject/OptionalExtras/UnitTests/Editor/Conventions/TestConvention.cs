...
namespace Zenject.Tests.Convention
{
    ...
    public class TestConvention : ZenjectUnitTestFixture
    {
        ...
        {
            Container.Bind<IFoo>().To(x => x.AllTypes().DerivingFrom<IFoo>()).AsTransient();
        ...
        public void TestDerivingFromFail()
        {
            Container
                .Bind<IFoo>()
                .To(x => x.AllTypes().DerivingFrom<IFoo>().FromAssemblyContaining<Vector3>())
                .AsTransient();
        ...
        public void TestInNamespace()
        {
            Container
                ...
                .To(x =>
                    x.AllTypes()
                        .DerivingFrom<IFoo>()
                        .InNamespace("Zenject.Tests.Convention.NamespaceTest")
                )
                .AsTransient();
