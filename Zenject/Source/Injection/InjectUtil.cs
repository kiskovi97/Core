...
namespace Zenject
{
    ...
    public static class InjectUtil
    {
        ...
        public static List<TypeValuePair> CreateArgListExplicit<TParam1, TParam2>(
            TParam1 param1,
            TParam2 param2
        )
        {
            return new List<TypeValuePair> { CreateTypePair(param1), CreateTypePair(param2) };
        }
        ...
        public static List<TypeValuePair> CreateArgListExplicit<
            TParam1,
            TParam2,
            TParam3,
            TParam4,
