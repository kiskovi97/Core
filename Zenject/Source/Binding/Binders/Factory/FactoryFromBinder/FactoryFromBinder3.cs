...
namespace Zenject
{
    ...
    public class FactoryFromBinder<TParam1, TParam2, TParam3, TContract> : FactoryFromBinderBase
    {
        ...
        )
        {
            ProviderFunc = (container) =>
                new MethodProviderWithContainer<TParam1, TParam2, TParam3, TContract>(method);
    ...
    public static class FactoryFromBinder3Extensions
    {
        ...
        >(
            ...
            Action<
                ConcreteBinderGeneric<IFactory<TParam1, TParam2, TParam3, TContract>>
            > factoryBindGenerator
        )
        {
            Guid factoryId;
            factoryBindGenerator(
                fromBinder.CreateIFactoryBinder<IFactory<TParam1, TParam2, TParam3, TContract>>(
                    out factoryId
                )
            );
            ...
            {
                return new IFactoryProvider<TParam1, TParam2, TParam3, TContract>(
                    container,
                    factoryId
                );
            };
            ...
            where TContract : IPoolable<TParam1, TParam2, TParam3, IMemoryPool>
        {
            return fromBinder.FromPoolableMemoryPool<
                ...
                TParam3,
                TContract,
                PoolableMemoryPool<TParam1, TParam2, TParam3, IMemoryPool, TContract>
            >(poolBindGenerator);
        }
            ...
            where TContract : Component, IPoolable<TParam1, TParam2, TParam3, IMemoryPool>
        {
            return fromBinder.FromPoolableMemoryPool<
                ...
                TParam3,
                TContract,
                MonoPoolableMemoryPool<TParam1, TParam2, TParam3, IMemoryPool, TContract>
            >(poolBindGenerator);
        }
#endif
