...
namespace Zenject
{
        ...
        : FactoryFromBinderBase
    {
        ...
        )
        {
            ProviderFunc = (container) =>
                new MethodProviderWithContainer<
                    TParam1,
                    TParam2,
                    TParam3,
                    TParam4,
    ...
    public static class FactoryFromBinder5Extensions
    {
        ...
        )
        {
            ...
            {
                return new IFactoryProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>(
                    container,
                    factoryId
                );
            };
        ...
        >(this FactoryFromBinder<TParam1, TParam2, TParam3, TParam4, TParam5, TContract> fromBinder)
            ...
            where TContract : Component,
                IPoolable<TParam1, TParam2, TParam3, TParam4, TParam5, IMemoryPool>
        {
