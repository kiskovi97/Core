...
namespace Zenject
{
    ...
    public class FactoryFromBinderBase : ScopeConcreteIdArgConditionCopyNonLazyBinder
    {
            ...
            : base(bindInfo)
        {
            ...
            factoryBindInfo.ProviderFunc = (container) =>
        ...
        public ConditionCopyNonLazyBinder FromInstance(object instance)
        {
            ...
            ProviderFunc = (container) =>
                new InstanceProvider(ContractType, instance, container, null);
        ...
        public ConditionCopyNonLazyBinder FromComponentOn(GameObject gameObject)
        {
            ...
            ProviderFunc = (container) =>
                new GetFromGameObjectComponentProvider(ContractType, gameObject, true);

            return this;
        }

        public ConditionCopyNonLazyBinder FromComponentOn(
        ...
        )
        {
            ...
            ProviderFunc = (container) =>
                new GetFromGameObjectGetterComponentProvider(ContractType, gameObjectGetter, true);
        ...
        )
        {
            ...
            ProviderFunc = (container) =>
                new InstantiateOnPrefabComponentProvider(
                    ContractType,
